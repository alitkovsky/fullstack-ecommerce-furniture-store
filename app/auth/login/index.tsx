                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                <Clerk.Connection
                                    name="github"
                                    className="flex w-full items-center justify-center gap-x-3 rounded-md bg-linear-to-b from-white to-neutral-50 px-2 py-1.5 text-sm font-medium text-neutral-950 shadow-sm outline-hidden ring-1 ring-black/5 hover:to-neutral-100 focus-visible:outline-offset-2 focus-visible:outline-neutral-600 active:text-neutral-950/60"
                                >
