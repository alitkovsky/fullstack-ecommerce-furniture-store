                    ...
                    <SignUp.Strategy name="email_code">
                        ...
                        <Clerk.Input
                            ...
                            render={({ value, status }) => (
                                <div
                                data-status={status}
                                className="relative h-9 w-8 rounded ring-1 ring-inset ring-zinc-300 data-[status=selected]:bg-sky-400/10 data-[status=selected]:shadow-[0_0_8px_2px_theme(colors.sky.400/30%)] data-[status=selected]:ring-ochre"
                                >
                                <AnimatePresence>
                                    {value && (
                                    <motion.span
                                ...
                                {status === 'cursor' && (
                                    ...
                                    className="absolute inset-0 z-10 rounded border border-ochre bg-sky-400/10 shadow-[0_0_8px_2px_theme(colors.sky.400/30%)]"
                                    />
                                )}
                                </div>
                            )}
