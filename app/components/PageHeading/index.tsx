...
const PageHeading: React.FC<PageHeadingProps> = ({ mainhead, subhead = mainhead }) => {
    return (
        <div className="relative">
            <div className="absolute inset-0 z-10 backdrop-blur-xs bg-white bg-opacity-25"></div>
            <div className="text-black flex justify-center pb-6 lg:pb-0 items-end lg:items-center h-[24vh] lg:h-[40vh] bg-center bg-no-repeat bg-cover bg-[url(/assets/page-heading/background.jpg)]">
                <div className="relative w-full gap-4 flex flex-col items-center z-20 px-8">
...

                    {
                        mainhead !== "Search" ?
                            ...
                            <div className="relative">
                                <input className="focus:outline-hidden px-4 py-2 rounded-lg w-full sm:w-[500px] pr-11" placeholder="Search for product..." type="text" name="" id="" />
